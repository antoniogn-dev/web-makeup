...
const PreguntasSection = () => {
    return (
        <section className="flex flex-col items-center mt-10 mb-20">
            <div className="relative bg-[url('/images/fondo-rosado.jpg')] bg-contain bg-fixed flex flex-col h-150 items-center px-5 w-full lg:flex-row lg:items-center 2xl:px-50 lg:h-100 xl:gap-4">
